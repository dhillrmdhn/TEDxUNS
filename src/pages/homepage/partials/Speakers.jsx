...
import Aya from "@images/speakers/Aya.png";
import Dinda from "@images/speakers/Dinda.png";
import Kevin from "@images/speakers/Kevin.png";
import Anton from "@images/speakers/Anton.png";
import Bambang from "@images/speakers/Bambang.png";
import Irfan from "@images/speakers/Irfan.png";
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center text-white space-y-10 py-10 bg-speakers-section bg-cover">
      ...
      <div className="space-y-7">
        <div className="flex flex-wrap justify-center gap-10 container">
          <FetchAllSpeakers />
        </div>
...
const FetchAllSpeakers = () => {
  ...
  const AllSpeakers = [
    ...
    },
    {
      ...
      subtitle: "",
      image: Bambang,
      speakersName: `"Pakdhe" Bambang Sugiarto.`,
    },
    {
      id: 6,
      speakers: "Speaker 6",
      title: "Dosen DKV FSRD UNS",
      subtitle: "",
      image: Irfan,
      speakersName: `Anugrah Irfan Ismail S.Sn. M.SN.`,
    },
  ];
              ...
              {AllSpeakers.find((speaker) => speaker.id === selectedId) && (
                <>
                  <motion.img
                    ...
                    className="rounded-xl mx-auto w-[250px] h-[300px] object-cover"
                  />
                  ...
                  <motion.h2 className="max-h-52 overflow-y-auto text-justify custom-scrollbar">
                    {
                      AllSpeakers.find((speaker) => speaker.id === selectedId)
                        .subtitle
                    }
